...
# Record the number of occurrences of keywords in different provinces
...
# Summarize Shanghai and Shanghai, Beijing and Beijing, etc.
...
# The heat values of all cities are normalized and adjusted in the same proportion according to the heat maximum city of 100.
...
##############################################
# The above is the data preprocessing, and the following is the drawing.
